...
internal static class GeneratorExtensions
{
    ...
    public static string GetPluginSerializationDirectoryPath(this GeneratorId generatorId, string rootPath)
    {
        return Path.Combine(
            rootPath,
    ...
    {
        return Path.Combine(
            generatorId.GetPluginSerializationDirectoryPath(rootPath),
