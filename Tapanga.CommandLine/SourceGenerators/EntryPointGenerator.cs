...
{
    ClassesWithInterfacesReceiver interfacesReceiver = new ClassesWithInterfacesReceiver(nameof(IGeneratorProvider));
...
{{
    ...
    {{
        ...
        var factories = provider.{nameof(IGeneratorProvider.GetGeneratorFactories)}();
